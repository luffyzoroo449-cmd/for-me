...
const THEME_DATA = {
	WorldTheme.FOREST: {
		...
		"music_mood": SoundManager.GameMood.CALM
	},
	WorldTheme.LAVA: {
		...
		"music_mood": SoundManager.GameMood.INTENSE
	},
	WorldTheme.SHADOW_REALM: {
		...
		"music_mood": SoundManager.GameMood.SUSPENSE
	},
	WorldTheme.FROZEN_WASTE: {
		...
		"music_mood": SoundManager.GameMood.MYSTERY
	}
}
