...
# --- Adaptive State ---
enum GameMood { CALM, SUSPENSE, COMBAT, BOSS, VICTORY, STORY, MYSTERY, INTENSE }
...
func _get_music_for_mood(mood: GameMood) -> String:
	match mood:
		...
		GameMood.MYSTERY: return "res://assets/audio/bgm/mystery_ambient.mp3"
		GameMood.INTENSE: return "res://assets/audio/bgm/lava_intense.mp3"
